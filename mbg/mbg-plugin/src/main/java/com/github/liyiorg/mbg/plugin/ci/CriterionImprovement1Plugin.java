...
/**
 * 
 * Example Criterion improvement 1<br>
 * 1 Replace Criterion to com.github.liyiorg.mbg.support.example.Criterion<br>
 * 2 GeneratedCriteria extends
 * com.github.liyiorg.mbg.support.example.MbgGeneratedCriteria
 * 
 * @author LiYi
 *
 */
public class CriterionImprovement1Plugin extends PluginAdapter {

	private static Log log = LogFactory.getLog(CriterionImprovement1Plugin.class);
