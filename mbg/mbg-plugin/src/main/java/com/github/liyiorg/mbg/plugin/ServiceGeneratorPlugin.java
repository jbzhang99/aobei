...
public class ServiceGeneratorPlugin extends SuperMapperGeneratorPlugin {
	...
	private static final String SPRING_PROPERTY_NAME = "spring";
	...
	private static final String MbgUpsertServiceClass = "com.github.liyiorg.mbg.support.service.MbgUpsertService";
	
	private static final String MbgServiceSupportClass = "com.github.liyiorg.mbg.support.service.MbgServiceSupport";
	
	private static final String MbgMapperTemplateFactoryClass = "com.github.liyiorg.mbg.template.factory.MbgMapperTemplateFactory";
	
	private static final String NoKeyClass = "com.github.liyiorg.mbg.support.model.NoKey";
	
	@Override
	public void initialized(IntrospectedTable introspectedTable) {
		Object pro_spring = properties.get(SPRING_PROPERTY_NAME);
		if (pro_spring != null && StringUtility.stringHasValue(pro_spring.toString())) {
			spring = StringUtility.isTrue(pro_spring.toString());
		}
	...
	public boolean clientGenerated(Interface interfaze, TopLevelClass topLevelClass,
		...
		if(!readonly){
			...
			if(introspectedTable.getTableConfiguration().getGeneratedKey() == null){
				superInterfaces.add(MbgUpsertServiceClass);
			}
		}
		...
		String serviceCodeImpl = builderServiceImpl(baseRecordType, baseRecordTypeWithBLOBs, exampleType, primaryKeyType,spring);
	 ...
	 * @return code
	 */
	private String builderServiceImpl(String baseRecordType,String baseRecordTypeWithBLOBs,String exampleType,String primaryKeyType,boolean spring){
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.append("package ").append(targetImplPackage).append(";").append(System.lineSeparator())
					 .append(System.lineSeparator());
		if(spring){
		stringBuilder
					.append("import org.springframework.beans.factory.annotation.Autowired").append(";").append(System.lineSeparator())
		...
		stringBuilder.append("import ").append(targetPackage).append(".").append(shortClassName(baseRecordType)).append("Service").append(";").append(System.lineSeparator())
					 ...
					 .append("import ").append(MbgMapperTemplateFactoryClass).append(";").append(System.lineSeparator())
					 .append(System.lineSeparator());
		...
		stringBuilder.append("public class ").append(shortClassName(baseRecordType)).append("ServiceImpl extends ").append(shortClassName(MbgServiceSupportClass))
					 ...
					 .append(System.lineSeparator());
		if(spring){
			stringBuilder.append("\t@Autowired").append(System.lineSeparator());
		}
		...
		if(spring){
			stringBuilder.append("\t@Autowired").append(System.lineSeparator())
			.append("\tprivate void initService(MbgMapperTemplateFactory mbgMapperTemplateFactory){").append(System.lineSeparator())
			.append("\t\tsuper.mbgMapperTemplate = mbgMapperTemplateFactory.getMbgMapperTemplate(").append(shortNameLowerCase).append("Mapper);").append(System.lineSeparator())
			.append("\t}");
		}
		stringBuilder.append(System.lineSeparator())
			.append("}");
