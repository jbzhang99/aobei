...
@Configuration
public class CompensationSecondTask {
	...
	private void extractData() {
        ...
        long autoIncrId = idGenerator.getAutoIncrNum("CSCT"+date);
        if (autoIncrId != 1){
            return;
        }
        halfMonth();
    ...
    public void halfMonth(){
        ...
        compensationExample.or().andConfirm_datetimeBetween(sixteenDate,endDate).andCompensation_statusEqualTo(2);
